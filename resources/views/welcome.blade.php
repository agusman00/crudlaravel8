...
<head>
    ...
    <title>Selamat datang bossmuda</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/log/myaccountd">My profile</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/log/login" data-toggle="modal" data-target="#logoutModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Logout
                                </a>
                            </div>
...
<!--Content Area-->
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Mohon Maaf Untuk Fitur Ini Belum Bisa Di Akses</h5>
                        <div class="row">
                        <div class="card text-center ml-2" style="width: 12rem;">
                        <div class="card-body">
                            <h5 class="card-title">IMPORT PDF</h5>
                            <a href="#" class="btn btn-primary">Go IMPORT</a>
                        </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary">Go Export</a>
                        </div>
                        </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-mail fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/log/login">Logout</a>
                </div>
            </div>
        </div>
    </div>

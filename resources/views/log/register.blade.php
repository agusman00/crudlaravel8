                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="/log/registeruser" method="POST">
                            @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="nametext" placeholder="Name">
                                    @error('nametext')
                            ...
                            <div class="text-center">
                                <a class="small" href="/log/login">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
